...
/**
 * Pocket VSK · 4A Input-Output model (replaces the old 5A).
...
const ADMIN_SUBS: SubDomainDef[] = [
  ...
  },
  {
    ...
    name_gu: "સતત વ્યાવસાયિક વિકાસ (CPD)",
  },
];
