...
const RAW: Array<Partial<CatItem> & Pick<CatItem, "id" | "domain_id" | "name" | "name_gu" | "unit" | "direction" | "data_source">> = [
  ...
  { id: "asm_sat2", domain_id: "assessment", name: "Semester Assessment Test 2 (SAT2)", name_gu: "સેમેસ્ટર મૂલ્યાંકન કસોટી 2 (SAT2)", unit: "%", direction: "higher", data_source: "Xamta bot", frequency: "Yearly", displayStrategy: "snapshot_latest", hero: true, scheduleNote: "March", metrics: resultSubMetrics("SAT2", "%", "avgScore", "Avg score", "સરેરાશ સ્કોર"), formula: "Latest SAT Result % (SAT2, current year); year-on-year change vs the previous SAT2.", description: "Latest SAT result — the result-first Assessment headline." },
  ...
  { id: "asm_remediation", domain_id: "assessment", name: "SAT reports downloaded in classrooms", name_gu: "વર્ગખંડોમાં ડાઉનલોડ થયેલ SAT રિપોર્ટ", unit: "%", direction: "higher", data_source: "Gyan Prabhav bot", frequency: "Daily", displayStrategy: "compliance", showLastUpdatedOnUi: true, suppressDelta: true, formula: "(Classrooms Where Report Was Downloaded / Total Classrooms) × 100", description: "Gyan Prabhav generates a SAT report card per classroom; this is the share of classrooms that downloaded it." },
  ...
  { id: "ad_gshala", domain_id: "administration", sub_domain: "adm_visits", name: "GSHALA + GSHALA Plus usage", name_gu: "GSHALA + GSHALA Plus ઉપયોગ", unit: "%", direction: "higher", data_source: "LMS", availableInDataLake: false, frequency: "Monthly", displayStrategy: "compliance", lowestLevel: "school", roleVisibility: [...NON_TEACHER], showLastUpdatedOnUi: true, formula: "Active GSHALA + GSHALA Plus users / Total eligible teachers & students × 100 (combined)." },
  { id: "ad_smart", domain_id: "administration", sub_domain: "adm_visits", name: "Smartclass usage", name_gu: "સ્માર્ટક્લાસ ઉપયોગ", unit: "%", direction: "higher", data_source: "LMS", availableInDataLake: false, frequency: "Monthly", displayStrategy: "compliance", lowestLevel: "school", roleVisibility: [...NON_TEACHER], showLastUpdatedOnUi: true, formula: "Smartclass sessions conducted / sessions planned × 100." },
  { id: "ad_lab", domain_id: "administration", sub_domain: "adm_visits", name: "Computer lab usage", name_gu: "કમ્પ્યુટર લેબ ઉપયોગ", unit: "%", direction: "higher", data_source: "LMS", availableInDataLake: false, frequency: "Monthly", displayStrategy: "compliance", lowestLevel: "school", roleVisibility: [...NON_TEACHER], showLastUpdatedOnUi: true, formula: "Computer-lab periods conducted / periods scheduled × 100." },
  { id: "ad_pal", domain_id: "administration", sub_domain: "adm_visits", name: "PAL usage", name_gu: "PAL ઉપયોગ", unit: "%", direction: "higher", data_source: "LMS", availableInDataLake: false, frequency: "Monthly", displayStrategy: "compliance", lowestLevel: "school", roleVisibility: [...NON_TEACHER], showLastUpdatedOnUi: true, formula: "Personalised Adaptive Learning (PAL) active users / total enrolled × 100." },
  ...
  { id: "ret_dropout", domain_id: "administration", sub_domain: "adm_retention", name: "Untracked Students", name_gu: "અનટ્રેક કરેલા વિદ્યાર્થીઓ", unit: "count", direction: "lower", data_source: "CTS + EWS", availableInDataLake: false, frequency: "Daily", displayStrategy: "count_with_rate", lowestLevel: "school", showLastUpdatedOnUi: true, formula: "Students on roll who can no longer be located/tracked at the school (enrolment-gap method)." },
