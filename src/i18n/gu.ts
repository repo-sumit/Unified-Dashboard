...
export const gu: Dict = {
  ...
  kpi: {
    ...
    trend30d: "૩૦-દિવસનો વલણ", trendMonthly: "માસિક વલણ", recentTrend: "તાજેતરનો વલણ",
    cycleTitle: "ચક્ર-દર-ચક્ર", annualSnapshot: "વાર્ષિક સ્નેપશોટ (સાપ્તાહિક વલણ નહીં)", thisCycle: "આ ચક્ર",
  ...
  ogm: {
    ...
    attentionTitle: "શેના પર ધ્યાન જરૂરી",
    attentionHint: "તાકીદ પ્રમાણે આપમેળે ક્રમબદ્ધ",
    allClear: "અત્યારે કંઈ ગંભીર નથી. તમારા મુખ્ય સૂચકાંકો સારી સ્થિતિમાં છે.",
    ...
    insight: {
      peer_gap: "{label} {level} સરેરાશથી {metric} પાછળ ({extra})",
      low_domain: "{label} તમારો સૌથી નબળો ઇનપુટ છે, {metric}%",
      decline: "{label} ગયા ચક્ર સામે {metric} pp ઘટ્યું",
      chronic: "{metric} વિદ્યાર્થીઓ ૭+ દિવસ ગેરહાજર (નોંધણીના {extra}%)",
      chronicNoRate: "{metric} વિદ્યાર્થીઓ ૭+ દિવસ ગેરહાજર",
      coverage: "{extra} માંથી {metric} શાળાઓમાં GSQAC માપાયેલ; બાકી અંદાજિત",
    },
    freq: {
