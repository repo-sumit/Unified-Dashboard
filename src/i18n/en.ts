export const en = {
  ...
  kpi: {
    ...
    trend30d: "30-day trend", trendMonthly: "Monthly trend", recentTrend: "Recent trend",
    cycleTitle: "Cycle over cycle", annualSnapshot: "Annual snapshot (no weekly trend)", thisCycle: "This cycle",
  ...
  ogm: {
    ...
    attentionHint: "Auto-ranked by urgency",
    allClear: "Nothing critical right now. Your key indicators are on track.",
    ...
    insight: {
      peer_gap: "{label} is {metric} behind the {level} average ({extra})",
      low_domain: "{label} is your weakest input at {metric}%",
      decline: "{label} fell {metric} pp vs last cycle",
      chronic: "{metric} students absent 7+ days ({extra}% of enrolled)",
      chronicNoRate: "{metric} students absent 7+ days",
      coverage: "GSQAC measured for {metric} of {extra} schools; the rest are estimated",
    },
    freq: {
